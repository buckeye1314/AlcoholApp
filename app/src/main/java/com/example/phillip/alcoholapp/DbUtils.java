...
/**
 * Created by Phillip on 6/4/2016.
 */
public class DbUtils {
    private static final String DB_PATH = "/data/data/com.mypackage.alcoholapp/databases/";
    private static final String DB_NAME = "Alcohol";
